...
public class SaveLoad : MonoBehaviour {
	...
	void OnGUI(){
		if(menu){
			GUI.Box ( new Rect(Screen.width / 2 - 180,190,360,340), "Menu");
			if (GUI.Button ( new Rect(Screen.width / 2 - 110,265,220,100), "Save Game")) {
				SaveData();
				OnOffMenu();
			}
			...
			if (GUI.Button ( new Rect(Screen.width / 2 - 110,405,220,100), "Quit Game")) {
